...
public class ExportManifestTest extends TestCase {
  ...
  public ExportManifestTest() {
    ...
    jobScheduleRequest.setJobState( JobState.UNKNOWN );
...
//    exportManifest.addSchedule( jobScheduleRequest );
  ...
  public void testUnMarshal() {
    ...
    JobScheduleRequest jobScheduleRequest = (JobScheduleRequest ) importManifest.getScheduleList().get( 0 );
    ...
    assertEquals( JobState.UNKNOWN, jobScheduleRequest.getJobState() );
